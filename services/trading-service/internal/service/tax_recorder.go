...
type TaxRecorder interface {
	...
	// capital gains. The loss base is denominated in currencyCode.
	ReduceTax(ctx context.Context, accountNumber string, employeeID *uint, lossBase float64, currencyCode string) error
}
